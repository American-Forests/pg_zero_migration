...
import {
  DbTestFixtureLoader,
  FixtureLoadError,
} from "./db-test-fixture-loader.js"
    ...
    it("should resolve simple dependency chain correctly", () => {
      const schemas = {
        ...
        comments: {
          ...
          foreignKeys: [
            { fromColumn: "post_id", toTable: "posts", toColumn: "id" },
          ],
          indexes: [],
        },
      }
    ...
    it("should handle circular dependencies gracefully", () => {
      const circularSchemas = {
        table_a: {
          ...
          foreignKeys: [
            { fromColumn: "b_id", toTable: "table_b", toColumn: "id" },
          ],
          indexes: [],
        },
        table_b: {
          ...
          foreignKeys: [
            { fromColumn: "a_id", toTable: "table_a", toColumn: "id" },
          ],
          indexes: [],
        },
      }
